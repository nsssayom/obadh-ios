...
the native keyboard. Tapping one **replaces** the composed word — the typed
text was the emoji's query ("bhalobasha" + tap yields ❤️, not the word plus
the emoji) — and the discarded query is not committed to autosuggest
learning.
